...
import { Boutique3Component } from './boutique3';
...
describe('Boutique3Component (variante /boutique3)', () => {
  let component: Boutique3Component;
  let fixture: ComponentFixture<Boutique3Component>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(Boutique3Component);
  ...
  it('se déclare sur /boutique3 et hors index', () => {
    ...
    expect(seoServiceSpy.updateMetaTags).toHaveBeenCalledWith(
      jasmine.objectContaining({ title: 'Boutique (v3)', url: '/boutique3', noIndex: true }),
    );
  });
